...
*StreamApi* | [**deleteScheduleConfiguration**](docs/Api/StreamApi.md#deletescheduleconfiguration) | **DELETE** /event_manager/stream/schedule_configuration/{schedule_configuration_id} | Delete a Stream Schedule Configuration
