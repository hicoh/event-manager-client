...
namespace HiCo\EventManagerClient;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (HiCo\EventManagerClient) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://virtserver.swaggerhub.com/HighCohesion/Public-Gateway/1.0.0",
