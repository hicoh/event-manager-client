...
class JobApi
{
     ...
     * @param  string $dueAt Jobs filtered by due_at date (due_at&#x3D;2021/03/21 12:23:22,gte) (optional)
     *
     * @throws \HiCo\EventManagerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HiCo\EventManagerClient\Model\SyncResponse
     */
    public function deleteJob($id = null, $streamId = null, $status = null, $dueAt = null)
    {
        list($response) = $this->deleteJobWithHttpInfo($id, $streamId, $status, $dueAt);
        return $response;
    }
     ...
     */
    public function deleteJobWithHttpInfo($id = null, $streamId = null, $status = null, $dueAt = null)
    {
        $request = $this->deleteJobRequest($id, $streamId, $status, $dueAt);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteJobAsync($id = null, $streamId = null, $status = null, $dueAt = null)
    {
        return $this->deleteJobAsyncWithHttpInfo($id, $streamId, $status, $dueAt)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteJobAsyncWithHttpInfo($id = null, $streamId = null, $status = null, $dueAt = null)
    {
        $returnType = '\HiCo\EventManagerClient\Model\SyncResponse';
        $request = $this->deleteJobRequest($id, $streamId, $status, $dueAt);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteJobRequest($id = null, $streamId = null, $status = null, $dueAt = null)
    {
