...
class JobApi
{
    ...
    /**
     * Operation createSourceJob
     *
     * Trigger a job to be sent to the source
     *
     * @param  string $organisationId organisationId (optional)
     * @param  \HiCo\EventManagerClient\Model\SourceJobRequest $sourceJobRequest sourceJobRequest (optional)
     *
     * @throws \HiCo\EventManagerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HiCo\EventManagerClient\Model\AsyncResponse
     */
    public function createSourceJob($organisationId = null, $sourceJobRequest = null)
    {
        list($response) = $this->createSourceJobWithHttpInfo($organisationId, $sourceJobRequest);
        return $response;
    }

    /**
     * Operation createSourceJobWithHttpInfo
     *
     * Trigger a job to be sent to the source
     *
     * @param  string $organisationId (optional)
     * @param  \HiCo\EventManagerClient\Model\SourceJobRequest $sourceJobRequest (optional)
     *
     * @throws \HiCo\EventManagerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HiCo\EventManagerClient\Model\AsyncResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSourceJobWithHttpInfo($organisationId = null, $sourceJobRequest = null)
    {
        $request = $this->createSourceJobRequest($organisationId, $sourceJobRequest);
    ...
    /**
     * Operation createSourceJobAsync
     *
     * Trigger a job to be sent to the source
     *
     * @param  string $organisationId (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSourceJobAsync($organisationId = null, $sourceJobRequest = null)
    {
        return $this->createSourceJobAsyncWithHttpInfo($organisationId, $sourceJobRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createSourceJobAsyncWithHttpInfo
     *
     * Trigger a job to be sent to the source
     *
     * @param  string $organisationId (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSourceJobAsyncWithHttpInfo($organisationId = null, $sourceJobRequest = null)
    {
        $returnType = '\HiCo\EventManagerClient\Model\AsyncResponse';
        $request = $this->createSourceJobRequest($organisationId, $sourceJobRequest);
    ...
    /**
     * Create request for operation 'createSourceJob'
     *
     * @param  string $organisationId (optional)
     * @param  \HiCo\EventManagerClient\Model\SourceJobRequest $sourceJobRequest (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createSourceJobRequest($organisationId = null, $sourceJobRequest = null)
    {

        $resourcePath = '/event_manager/job/source';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($sourceJobRequest)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($sourceJobRequest));
            } else {
                $httpBody = $sourceJobRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  string $dueAt Delete jobs filtered by due_at date (due_at&#x3D;2021/03/21 12:23:22,gte) (optional)
     *
     * @throws \HiCo\EventManagerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HiCo\EventManagerClient\Model\SyncResponse
     */
    public function deleteJob($organisationId = null, $id = null, $streamId = null, $status = null, $dueAt = null)
    {
        list($response) = $this->deleteJobWithHttpInfo($organisationId, $id, $streamId, $status, $dueAt);
        return $response;
    }
     ...
     */
    public function deleteJobWithHttpInfo($organisationId = null, $id = null, $streamId = null, $status = null, $dueAt = null)
    {
        $request = $this->deleteJobRequest($organisationId, $id, $streamId, $status, $dueAt);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteJobAsync($organisationId = null, $id = null, $streamId = null, $status = null, $dueAt = null)
    {
        return $this->deleteJobAsyncWithHttpInfo($organisationId, $id, $streamId, $status, $dueAt)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteJobAsyncWithHttpInfo($organisationId = null, $id = null, $streamId = null, $status = null, $dueAt = null)
    {
        $returnType = '\HiCo\EventManagerClient\Model\SyncResponse';
        $request = $this->deleteJobRequest($organisationId, $id, $streamId, $status, $dueAt);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteJobRequest($organisationId = null, $id = null, $streamId = null, $status = null, $dueAt = null)
    {
        ...
        // query params
        if ($dueAt !== null) {
            if('form' === 'form' && is_array($dueAt)) {
                foreach($dueAt as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['due_at'] = $dueAt;
            }
        }
