...
class AggregateApi
{
     ...
     * @return \HiCo\EventManagerClient\Model\AsyncResponse
     */
    public function replicateParentAggregateEvent($replicateParentAggregateEventRequest)
    {
        list($response) = $this->replicateParentAggregateEventWithHttpInfo($replicateParentAggregateEventRequest);
        return $response;
    }
     ...
     * @return array of \HiCo\EventManagerClient\Model\AsyncResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function replicateParentAggregateEventWithHttpInfo($replicateParentAggregateEventRequest)
    {
        $request = $this->replicateParentAggregateEventRequest($replicateParentAggregateEventRequest);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replicateParentAggregateEventAsync($replicateParentAggregateEventRequest)
    {
        return $this->replicateParentAggregateEventAsyncWithHttpInfo($replicateParentAggregateEventRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replicateParentAggregateEventAsyncWithHttpInfo($replicateParentAggregateEventRequest)
    {
        $returnType = '\HiCo\EventManagerClient\Model\AsyncResponse';
        $request = $this->replicateParentAggregateEventRequest($replicateParentAggregateEventRequest);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function replicateParentAggregateEventRequest($replicateParentAggregateEventRequest)
    {
