...
class EventApi
{
     ...
     */
    public function redriveEvent($redriveEventRequest)
    {
        list($response) = $this->redriveEventWithHttpInfo($redriveEventRequest);
        return $response;
    }
     ...
     */
    public function redriveEventWithHttpInfo($redriveEventRequest)
    {
        $request = $this->redriveEventRequest($redriveEventRequest);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redriveEventAsync($redriveEventRequest)
    {
        return $this->redriveEventAsyncWithHttpInfo($redriveEventRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redriveEventAsyncWithHttpInfo($redriveEventRequest)
    {
        $returnType = '\HiCo\EventManagerClient\Model\AsyncResponse';
        $request = $this->redriveEventRequest($redriveEventRequest);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function redriveEventRequest($redriveEventRequest)
    {
     ...
     * @return \HiCo\EventManagerClient\Model\AsyncResponse
     */
    public function updateChildEvent($updateChildEventRequest)
    {
        list($response) = $this->updateChildEventWithHttpInfo($updateChildEventRequest);
        return $response;
    }
     ...
     * @return array of \HiCo\EventManagerClient\Model\AsyncResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateChildEventWithHttpInfo($updateChildEventRequest)
    {
        $request = $this->updateChildEventRequest($updateChildEventRequest);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateChildEventAsync($updateChildEventRequest)
    {
        return $this->updateChildEventAsyncWithHttpInfo($updateChildEventRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateChildEventAsyncWithHttpInfo($updateChildEventRequest)
    {
        $returnType = '\HiCo\EventManagerClient\Model\AsyncResponse';
        $request = $this->updateChildEventRequest($updateChildEventRequest);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateChildEventRequest($updateChildEventRequest)
    {
     ...
     * @return \HiCo\EventManagerClient\Model\AsyncResponse
     */
    public function updateEvent($updateEventRequest)
    {
        list($response) = $this->updateEventWithHttpInfo($updateEventRequest);
        return $response;
    }
     ...
     * @return array of \HiCo\EventManagerClient\Model\AsyncResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateEventWithHttpInfo($updateEventRequest)
    {
        $request = $this->updateEventRequest($updateEventRequest);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEventAsync($updateEventRequest)
    {
        return $this->updateEventAsyncWithHttpInfo($updateEventRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEventAsyncWithHttpInfo($updateEventRequest)
    {
        $returnType = '\HiCo\EventManagerClient\Model\AsyncResponse';
        $request = $this->updateEventRequest($updateEventRequest);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateEventRequest($updateEventRequest)
    {
