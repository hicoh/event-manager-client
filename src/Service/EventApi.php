...
class EventApi
{
     ...
     * @return \HiCo\EventManagerClient\Model\AsyncResponse
     */
    public function replicateEvent($replicateEventRequest = null)
    {
        list($response) = $this->replicateEventWithHttpInfo($replicateEventRequest);
        return $response;
    }
     ...
     * @return array of \HiCo\EventManagerClient\Model\AsyncResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function replicateEventWithHttpInfo($replicateEventRequest = null)
    {
        $request = $this->replicateEventRequest($replicateEventRequest);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replicateEventAsync($replicateEventRequest = null)
    {
        return $this->replicateEventAsyncWithHttpInfo($replicateEventRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replicateEventAsyncWithHttpInfo($replicateEventRequest = null)
    {
        $returnType = '\HiCo\EventManagerClient\Model\AsyncResponse';
        $request = $this->replicateEventRequest($replicateEventRequest);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function replicateEventRequest($replicateEventRequest = null)
    {
