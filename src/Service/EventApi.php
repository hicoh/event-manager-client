...
class EventApi
{
     ...
     */
    public function getEventById($eventId, $organisationId = null)
    {
        list($response) = $this->getEventByIdWithHttpInfo($eventId, $organisationId);
        return $response;
    }
     ...
     */
    public function getEventByIdWithHttpInfo($eventId, $organisationId = null)
    {
        $request = $this->getEventByIdRequest($eventId, $organisationId);
     ...
     */
    public function getEventByIdAsync($eventId, $organisationId = null)
    {
        return $this->getEventByIdAsyncWithHttpInfo($eventId, $organisationId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventByIdAsyncWithHttpInfo($eventId, $organisationId = null)
    {
        $returnType = '\HiCo\EventManagerClient\Model\Event';
        $request = $this->getEventByIdRequest($eventId, $organisationId);
     ...
     */
    public function getEventByIdRequest($eventId, $organisationId = null)
    {
     ...
     * @return \HiCo\EventManagerClient\Model\Event[]|\HiCo\EventManagerClient\Model\ErrorResponse
     */
    public function getEventsBy($organisationId = null, $eventId = null, $jobId = null, $streamId = null, $status = null, $limit = null, $orderBy = null, $offset = null)
    {
        list($response) = $this->getEventsByWithHttpInfo($organisationId, $eventId, $jobId, $streamId, $status, $limit, $orderBy, $offset);
        return $response;
    }
     ...
     * @return array of \HiCo\EventManagerClient\Model\Event[]|\HiCo\EventManagerClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEventsByWithHttpInfo($organisationId = null, $eventId = null, $jobId = null, $streamId = null, $status = null, $limit = null, $orderBy = null, $offset = null)
    {
        $request = $this->getEventsByRequest($organisationId, $eventId, $jobId, $streamId, $status, $limit, $orderBy, $offset);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventsByAsync($organisationId = null, $eventId = null, $jobId = null, $streamId = null, $status = null, $limit = null, $orderBy = null, $offset = null)
    {
        return $this->getEventsByAsyncWithHttpInfo($organisationId, $eventId, $jobId, $streamId, $status, $limit, $orderBy, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventsByAsyncWithHttpInfo($organisationId = null, $eventId = null, $jobId = null, $streamId = null, $status = null, $limit = null, $orderBy = null, $offset = null)
    {
        $returnType = '\HiCo\EventManagerClient\Model\Event[]';
        $request = $this->getEventsByRequest($organisationId, $eventId, $jobId, $streamId, $status, $limit, $orderBy, $offset);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEventsByRequest($organisationId = null, $eventId = null, $jobId = null, $streamId = null, $status = null, $limit = null, $orderBy = null, $offset = null)
    {
    ...
    /**
     * Operation redriveEvent
     *
     * Redrive Event
     *
     * @param  \HiCo\EventManagerClient\Model\RedriveEventRequest $redriveEventRequest The event to redrive (required)
     * @param  string $organisationId organisationId (optional)
     *
     * @throws \HiCo\EventManagerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function redriveEvent($redriveEventRequest, $organisationId = null)
    {
        list($response) = $this->redriveEventWithHttpInfo($redriveEventRequest, $organisationId);
        return $response;
    }

    /**
     * Operation redriveEventWithHttpInfo
     *
     * Redrive Event
     *
     * @param  \HiCo\EventManagerClient\Model\RedriveEventRequest $redriveEventRequest The event to redrive (required)
     ...
     */
    public function redriveEventWithHttpInfo($redriveEventRequest, $organisationId = null)
    {
        $request = $this->redriveEventRequest($redriveEventRequest, $organisationId);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redriveEventAsync($redriveEventRequest, $organisationId = null)
    {
        return $this->redriveEventAsyncWithHttpInfo($redriveEventRequest, $organisationId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation redriveEventAsyncWithHttpInfo
     *
     * Redrive Event
     *
     * @param  \HiCo\EventManagerClient\Model\RedriveEventRequest $redriveEventRequest The event to redrive (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redriveEventAsyncWithHttpInfo($redriveEventRequest, $organisationId = null)
    {
        $returnType = '\HiCo\EventManagerClient\Model\AsyncResponse';
        $request = $this->redriveEventRequest($redriveEventRequest, $organisationId);
    ...
    /**
     * Create request for operation 'redriveEvent'
     *
     * @param  \HiCo\EventManagerClient\Model\RedriveEventRequest $redriveEventRequest The event to redrive (required)
     * @param  string $organisationId (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function redriveEventRequest($redriveEventRequest, $organisationId = null)
    {
        // verify the required parameter 'redriveEventRequest' is set
        if ($redriveEventRequest === null || (is_array($redriveEventRequest) && count($redriveEventRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $redriveEventRequest when calling redriveEvent'
            );
        }

        $resourcePath = '/event_manager/event/redrive';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($redriveEventRequest)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($redriveEventRequest));
            } else {
                $httpBody = $redriveEventRequest;
            }
