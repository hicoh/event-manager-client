...
class ApiKeyApi
{
     ...
     */
    public function createApiKey($organisationId)
    {
        list($response) = $this->createApiKeyWithHttpInfo($organisationId);
        return $response;
    }
     ...
     */
    public function createApiKeyWithHttpInfo($organisationId)
    {
        $request = $this->createApiKeyRequest($organisationId);
     ...
     */
    public function createApiKeyAsync($organisationId)
    {
        return $this->createApiKeyAsyncWithHttpInfo($organisationId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createApiKeyAsyncWithHttpInfo($organisationId)
    {
        $returnType = '\HiCo\EventManagerClient\Model\ApiKeyResponse';
        $request = $this->createApiKeyRequest($organisationId);
     ...
     */
    public function createApiKeyRequest($organisationId)
    {
        // verify the required parameter 'organisationId' is set
        if ($organisationId === null || (is_array($organisationId) && count($organisationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organisationId when calling createApiKey'
            );
        }

        $resourcePath = '/event_manager/api_key/{organisation_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
