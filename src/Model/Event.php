...
class Event implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCreatedAt($createdAt)
    {
        ...
        if (!is_null($createdAt) && (!preg_match("/^((0[1-9]|[12]\\\\d|3[01])\\\/(0[1-9]|1[0-2])\\\/[12]\\\\d{3}) ([01]?\\\\d|2[0-3]):([0-5]?\\\\d):([0-5]?\\\\d)$/", $createdAt))) {
            throw new \InvalidArgumentException("invalid value for $createdAt when calling Event., must conform to the pattern /^((0[1-9]|[12]\\\\d|3[01])\\\/(0[1-9]|1[0-2])\\\/[12]\\\\d{3}) ([01]?\\\\d|2[0-3]):([0-5]?\\\\d):([0-5]?\\\\d)$/.");
        }
    ...
    public function setUpdatedAt($updatedAt)
    {
        ...
        if (!is_null($updatedAt) && (!preg_match("/^((0[1-9]|[12]\\\\d|3[01])\\\/(0[1-9]|1[0-2])\\\/[12]\\\\d{3}) ([01]?\\\\d|2[0-3]):([0-5]?\\\\d):([0-5]?\\\\d)$/", $updatedAt))) {
            throw new \InvalidArgumentException("invalid value for $updatedAt when calling Event., must conform to the pattern /^((0[1-9]|[12]\\\\d|3[01])\\\/(0[1-9]|1[0-2])\\\/[12]\\\\d{3}) ([01]?\\\\d|2[0-3]):([0-5]?\\\\d):([0-5]?\\\\d)$/.");
        }
